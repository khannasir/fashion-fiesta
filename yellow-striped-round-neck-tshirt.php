  ...
  <div class="container">
	...
	<div class="container">
        ...
        <span class="zoom" id='product1'>
				<img src="images/t-shirt-14.jpg" style="width:350px;height: 450px;" data-aos="zoom-In">
        </span>
			</div>
			<div class="col-sm-6">
				<h3>Yellow Striped Round Neck T-Shirt</h3>
				...
				<p><strong>Rs.450</strong> &nbsp &nbsp<strike>Rs.499</strike></p>
          ...
          <div class="size-div">
            <button class="shirt-size">L</button>  
          </div>
          <div class="size-div">
            <button class="shirt-size">XL</button>  
          </div>
        </div>
        <div class="row">
          <?php
